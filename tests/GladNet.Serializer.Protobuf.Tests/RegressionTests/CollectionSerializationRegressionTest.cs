...
namespace GladNet.Serializer.Protobuf.Tests
{
	...
	public class CollectionSerializationRegressionTest
	{
		...
		public void Test_Can_Serialize_Payloads_With_Collections()
		{
			...
			GameServerListResponsePayload payload = new GameServerListResponsePayload(GameServerListResponseCode.One, new List<SimpleGameServerDetailsModel>(8) { new SimpleGameServerDetailsModel("Hello", IPAddress.Any, 5, ServerRegion.EU) });
		...
		[GladNetSerializationInclude(2, typeof(TestClassChild1), true)]
		...
		[GladNetSerializationContract]
		[GladNetSerializationInclude(2, typeof(TestClassChild2), true)]
		...
		[GladNetSerializationContract]
		[GladNetSerializationInclude(19, typeof(PacketPayload), false)]
