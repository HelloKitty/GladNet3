...
namespace GladNet
{
	...
	public interface IPeerPayloadSpecificMessageHandler<in TPayloadType, out TOutgoingPayloadType>
		...
		where TPayloadType : class
	{
		...
		Task HandleMessage(IPeerMessageContext<TOutgoingPayloadType> context, TPayloadType payload);
	}
}
