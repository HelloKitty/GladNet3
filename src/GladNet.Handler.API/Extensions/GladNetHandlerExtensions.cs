...
namespace GladNet
{
	...
	public static class GladNetHandlerExtensions
	{
		...
		public static IPeerMessageHandler<TIncomingPayloadType, TOutgoingPayloadType> AsTryHandler<TPayloadType, TIncomingPayloadType, TOutgoingPayloadType>(this IPeerPayloadSpecificMessageHandler<TPayloadType, TOutgoingPayloadType> handler)
