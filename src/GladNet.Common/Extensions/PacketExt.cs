...
{
	/// <summary>
	/// Provides extension methods for the <see cref="GladNet.Common.Packet"/> Type as well as its various enums.
	/// </summary>
	public static class PacketExt
	{
		/// <summary>
		/// This translates <see cref="NetDeliveryMethod"/> to GladNet <see cref="Packet.DeliveryMethod"/>
		...
		/// <returns>The equivalent <see cref="Packet.DeliveryMethod"/> for the given <see cref="NetDeliveryMethod"/></returns>
